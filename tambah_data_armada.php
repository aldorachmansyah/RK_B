		...
		<div style="margin-left: 30px;margin-top: 20px">
	      <form method="POST" action="#">
	        <table>
	          <tr>
	            <td>Nopol</td>
	            <td style="padding: 10px"><input type="text" name="judul" style="width: 300px"></td>
	          </tr>
	          <tr>
	            <td>Merk Kendaraan</td>
	            <td style="padding: 10px"><input type="text" name="edisi" style="width: 300px"></td>
	          </tr>
	          <tr>
	            <td>Jenis Kendaraan</td>
	            <td style="padding: 10px"><input type="text" name="pengarang" style="width: 300px"></td>
	          </tr>
	          <tr>
