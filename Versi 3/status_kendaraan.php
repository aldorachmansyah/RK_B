      ...
      <ul class="sidebar-menu">
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="status_kendaraan.php"><i class="fa fa-circle-o"></i>Home</a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a href="index_status_kendaraan.php"><i class="fa fa-circle-o"></i>List</a></li>
          </ul>
        </li>
      </ul>
    </section>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p>Mobil Masuk Bengkel Bulan Ini</p>
            </div>
            <div class="icon">
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="fa fa-inbox"></i>Grafik Masuk Bengkel per Bulan</li>
            </ul>
