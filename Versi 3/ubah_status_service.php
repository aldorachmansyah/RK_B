       ...
       <form role="form">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama Driver" disabled>
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Harga Sewa</label>
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Harga Sewa" disabled>
            </div>
            <div class="form-group">
          ...
          <div class="box-footer">
                <a href="index_status_kendaraan.php"<button type="submit" class="btn btn-primary">Submit</button></a>
            </div>
        </form> 
      </div> 
    </section>
